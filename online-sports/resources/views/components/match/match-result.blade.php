<div class="grid gap-4 place-items-center bg-gray-800 h-16 w-full border-b border-gray-900 hover:bg-gray-700 transition" style="grid-template-columns: 1fr 25px 40px 25px 1fr;">
